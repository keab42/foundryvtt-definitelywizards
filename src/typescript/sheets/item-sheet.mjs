 ...
 * @extends {ItemSheetV2}
 */
export class DefWizItemSheet extends api.HandlebarsApplicationMixin(
  sheets.ItemSheetV2
) {
  constructor(options = {}) {
    super(options);
  ...
  static DEFAULT_OPTIONS = {
    classes: ['definitely-wizards', 'item'],
    actions: {
  ...
  static PARTS = {
    header: {
      template: 'systems/definitely-wizards/templates/item/header.hbs',
    },
    tabs: {
    ...
    description: {
      template: 'systems/definitely-wizards/templates/item/description.hbs',
    },
    attributesFeature: {
      template:
        'systems/definitely-wizards/templates/item/attribute-parts/feature.hbs',
    },
    attributesGear: {
      template: 'systems/definitely-wizards/templates/item/attribute-parts/gear.hbs',
    },
    attributesSpell: {
      template: 'systems/definitely-wizards/templates/item/attribute-parts/spell.hbs',
    },
    effects: {
      template: 'systems/definitely-wizards/templates/item/effects.hbs',
    },
  };
